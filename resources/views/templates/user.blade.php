    ...
    <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
      ...
      <a class="sidebar-brand d-flex align-items-center justify-content-center" href="{{route('sampahs.index')}}">
        <div class="sidebar-brand-icon">
          <img src="foto/rempah.png" height='45' alt="" />
        </div>
        <div class="sidebar-brand-text mx-3">REMPAH</div>
      </a>
      ...
      <li class="nav-item active">
        ...
        <div id="collapseUtilities" class="collapse" aria-labelledby="headingUtilities" data-parent="#accordionSidebar">
          <div class="bg-white py-2 collapse-inner rounded">
            ...
            <a class="collapse-item" href="{{route('produks.index')}}">Lapak Saya</a>
            <a class="collapse-item" href="{{route('transaksis.index')}}">Transaksi Masuk</a>
			<a class="collapse-item" href="/transaksi_keluar">Transaksi Keluar</a>
			<a class="collapse-item" href="{{route('pendapatans.index')}}">Pendapatan</a>
          </div>
        </div>
      </li>
          ...
          <ul class="navbar-nav ml-auto">
            ...
            <li class="nav-item dropdown no-arrow">
              <a class="nav-link dropdown-toggle" href="#" id="userDropdown" role="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                <span class="mr-2 d-none d-lg-inline text-gray-600 small">Sulton Ainun Nazib</span>
                <img class="img-profile rounded-circle" src="foto/inun.jpg">
              </a>
