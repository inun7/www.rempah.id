            ...
            <div class="p-5">
              ...
              <form class="user">
                <div class="form-group row">
                  ...
                  <div class="col-sm-6">
                    <input type="text" class="form-control form-control-user" placeholder="Alamat">
                  </div>
                </div>
                <div class="form-group row">
                  <div class="col-sm-6 mb-3 mb-sm-0">
                    ...
                    <label for="laki-laki" name="jk">Laki-laki</label>
                    &emsp;
                    <input type="radio" name="jk">
                    <label for="perempuan" name="jk">Perempuan</label>
                  </div>
                  <div class="col-sm-6">
                    <input type="tel" class="form-control form-control-user" placeholder="No Telepon">
                  </div>
                </div>
                <div class="form-group row">
                  <div class="col-sm-6 mb-3 mb-sm-0">
              ...
              <div class="text-center">
                ...
                &emsp;
                <a class="small" href="/forgetpass">Forget Password?</a>
              </div>
            </div>
          </div>
        </div>
